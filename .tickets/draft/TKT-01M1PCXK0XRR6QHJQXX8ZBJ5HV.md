...
updated_at: 2026-09-04T14:24:47Z
created_by:
...
- [ ] git ticket --help exits 0 and prints the command list
- [ ] git ticket -h behaves the same as git ticket help
- [ ] A test covers both spellings so the asymmetry cannot return
