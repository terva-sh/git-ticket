...
func commands() []command {
	return []command{
		...
		{"import", "file the tickets an export carries as new tickets here", "DIR [--adopt]", runImport},
		...
		{"canvas", "read or write a board's pens, pins and frames, with no canvas running", "show | pens | explain ID | pen add ID | pen rm ID | pen order ID... | place ID | release ID... | frame add ID | inbox [--board B]", runCanvas},
